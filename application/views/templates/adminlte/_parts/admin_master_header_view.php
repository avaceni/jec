...
<head>
  ...
  <title>JEC Jogja | <? echo ucwords($this->uri->segment(1)).'-'.ucwords($this->uri->segment(2)) ?></title>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="<?= base_url().'/assets/adminlte/plugins/fontawesome/css/font-awesome.min.css' ?>">
  <!-- Ionicons -->
  <link rel="stylesheet" href="<?= base_url().'/assets/adminlte/plugins/ionicons/css/ionicons.min.css' ?>">
  <!-- Theme style -->
  <link rel="stylesheet" href="<?= base_url().'/assets/adminlte/dist/css/SansPro.css' ?>">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?=base_url().'admin'?>" class="logo">
      ...
      <span class="logo-mini"><b>J</b>EC</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Admin</b>JEC</span>
    </a>
    ...
    <section class="sidebar">
      ...
      */ ?>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="<? $this->uri->segment(2)==''||strtolower($this->uri->segment(2))=='dashboard'?printf('active'):'' ?>">
          <a href="<?php echo base_url().'admin/dashboard';?>">
            <i class="fa fa-dashboard"></i> <span>Dashboard</span>
          </a>
        </li>
        <li class="<? strtolower($this->uri->segment(2))=='user'?printf('active'):'' ?>">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class=""><a href="<?php echo base_url().'admin/groups';?>"><i class="fa fa-circle-o"></i> Groups</a></li>
        ...
        */?>
              ...
              {
                //$this->load->view('templates/_parts/user_menu_admin_view');
                echo $this->data['current_user_menu'];
              }
              ?>
        <li class="<? strtolower($this->uri->segment(2))=='menupages'?printf('active'):'' ?>">
          <a href="<?php echo base_url().'admin/menupages/index';?>">
            <i class="fa fa-navicon"></i> <span>Menu Pages</span>
          </a>
        </li>
        <? /*
        <li class="">
          <a href="#">
            <i class="fa fa-university"></i> <span>University Pages</span>
          </a>
        </li>
        */ ?>
        <li class="<? strtolower($this->uri->segment(2))=='newspages'?printf('active'):'' ?>">
          <a href="<?php echo base_url().'admin/newspages/index';?>">
            <i class="fa fa-newspaper-o"></i> <span>News Pages</span>
          </a>
        </li>
        <li class="<? strtolower($this->uri->segment(2))=='gallery'?printf('active'):'' ?>">
          <a href="<?php echo base_url().'admin/gallery/index';?>">
            <i class="fa fa-picture-o"></i> <span>Gallery</span>
          </a>
        </li>
        <li class="<? strtolower($this->uri->segment(2))=='register'?printf('active'):'' ?>">
          <a href="<?php echo base_url().'admin/register/index';?>">
            <i class="fa fa-edit"></i> <span>Register Users</span>
          </a>
        </li>
        <li class="<? strtolower($this->uri->segment(2))=='comment'?printf('active'):'' ?>">
