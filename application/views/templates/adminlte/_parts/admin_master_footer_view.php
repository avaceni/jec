...
<footer class="main-footer">
    ...
    <strong>Contact <a href="mailto:avaceni@gmail.com">avaceni@gmail.com</a> for trouble & maintenance<? /*Copyright &copy; <?= date("Y", time()) ?> <a href="http://jecjogja.com">JEC Jogja */?></a>.</strong> <? /* All rights reserved. */ ?>
  </footer>
...
<!-- jQuery UI 1.11.4 -->
<script src="<?= base_url().'/assets/adminlte/plugins/jQueryUI/jquery-ui.min.js' ?>"></script>
...
<!-- AdminLTE App -->
<script src="<?= base_url().'/assets/adminlte/dist/js/app.js' ?>"></script>
<? /*
