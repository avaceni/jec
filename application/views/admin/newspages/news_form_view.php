    ...
    <?=$this->session->flashdata('pesan')?>
      <div class="box box-info">
        ...
        ?>
          ...
          ?>
          <div class="col-sm-12"><img src="<? !empty($row_image)&&file_exists(FCPATH.$row_image)?printf(base_url().$row_image):printf(base_url().'assets/default/no_image_small.png') ?>"></div>
          <?
