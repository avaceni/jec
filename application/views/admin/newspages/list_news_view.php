          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">News Table</h3>
                <div class="box-tools">
                	<a href="<?php echo site_url('admin/newspages/create');?>" class="btn btn-info">Add News</a>
              	</div>
            </div>
            <!-- /.box-header -->
            ...
            <? }else{
              ...
              <tr>
                ...
                <td><? echo $CI->general_function->getDateFormat($rowContent->created_time) ?></td>
                <? /*
                ...
                */ ?>
                <td>
                  <a href="<?=base_url().'admin/newspages/edit/'.$rowContent->id?>" class="btn btn-info btn-sm"><i class="fa fa-pencil"></i></a>
                  <a href="<?=base_url().'admin/newspages/detail/'.$rowContent->id?>" class="btn btn-warning btn-sm"><i class="fa fa-search"></i></a>
                  <a href="<?=base_url().'admin/newspages/delete/'.$rowContent->id?>" class="btn btn-danger btn-sm" onclick="return confirm('Anda Yakin menghapus data ini?')"><i class="fa fa-trash"></i></a>
                </td>
              </tr>
              <? }
            }?>
